...
export const getFormFields = (messages: Translations): FormField[] => {
  ...
  },
  {
    ...
    required: true,
    options: [
      { value: 'Administración integral de tus pólizas', label: messages.form.fields.product.options.adminIntegral },
      { value: 'Autos, camiones y/o flotillas', label: messages.form.fields.product.options.autos },
      { value: 'Autos clásicos o exóticos', label: messages.form.fields.product.options.autosClasicos },
      { value: 'Aviación, drones, yates', label: messages.form.fields.product.options.aviacion },
      { value: 'Beneficios flexibles', label: messages.form.fields.product.options.beneficiosFlexibles },
      { value: 'Beneficios para colaboradores: gastos médicos, vida, accidentes personales, etc.', label: messages.form.fields.product.options.beneficiosColaboradores },
      { value: 'Carga/Transporte', label: messages.form.fields.product.options.carga },
      { value: 'Daños', label: messages.form.fields.product.options.danios },
      { value: 'Construcción/Obra Civil', label: messages.form.fields.product.options.construccion },
      ...
      { value: 'Inmuebles/Empresarial', label: messages.form.fields.product.options.inmuebles },
      { value: 'Líneas financieras: Cyber, D&O, E&O, Instituciones Financieras, Responsabilidad Profesional', label: messages.form.fields.product.options.lineasFinancieras },
      ...
      { value: 'Transporte de Mercancias', label: messages.form.fields.product.options.transporteMercancias },
